...
const About = (props) => {
	return (
		<div className='divText'>
			...
			<p className='text'>
				Priceless is an app created out of necessity. Many of us have items
				that we don't use and need to get rid of. In society we create
				unnecessary amounts of trash by throwing away items that could be
				given a second life if put into the hands of another person. Priceless
